...
# gitignored. The signing keyring has to live there too: the builder signs the
# commit from inside a Flatpak, and the sandbox has its own /tmp.
...
env_common=(
    OUT_DIR="$out" GNUPGHOME_DIR="$out/gnupg" REPO_DIR="$out/repo"
