...
| Rayburst | `dev.aninsomniacy.rayburst` | Same approval as `com.motrix.next` above, carried across upstream's own rename: [AnInsomniacy/motrix-next#522 (comment)](https://github.com/AnInsomniacy/motrix-next/issues/522#issuecomment-5322927943) — "没问题的，我后续会在 readme 添加为官方安装办法". Same maintainer and same repository (renamed to [AnInsomniacy/rayburst](https://github.com/AnInsomniacy/rayburst)); the project was renamed from Motrix Next in v4.0.0-beta.1, and this row covers the 4.x line packaged under the new id | 2026-08-18 |
